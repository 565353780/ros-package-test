...
int main(int argc, char **argv)
{
    ...
    topic_translator.init(argc, argv, "trans_camera_depth_info");

    topic_translator.setSubTopic("arm_camera/depth_registered/camera_info");

    topic_translator.setPubTopic("camera/depth/camera_info");

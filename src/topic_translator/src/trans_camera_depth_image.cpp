...
public:
    ...
    {
        pub_ = n_->advertise<sensor_msgs::Image>(topic, 1000);
    }
...
private:
    void static SubscriberCallback(const sensor_msgs::Image::ConstPtr& msg)
    {
...
int main(int argc, char **argv)
{
    ...
    topic_translator.init(argc, argv, "trans_camera_depth_image");

    topic_translator.setSubTopic("arm_camera/depth_registered/image_raw");

    topic_translator.setPubTopic("camera/depth/image_raw");

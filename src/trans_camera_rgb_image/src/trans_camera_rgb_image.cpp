...
int main(int argc, char **argv)
{
    ...
    topic_translator.init(argc, argv, "trans_camera_rgb_image");

    topic_translator.setSubTopic("arm_camera/rgb/image_raw");

    topic_translator.setPubTopic("camera/rgb/image_raw");
